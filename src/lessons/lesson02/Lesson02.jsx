...
function Lesson02() {
  ...
  return (
    <div>
      ...
      {/* чтобы работать с логиком и динамическими данными из 
      переменных мы используем фигурные скобки */}
      {element}
      <p>Здесь будет строка: {text}</p>
      {/* в фигурных скобках в верстке JSX можно использовать любые 
      логические конструкции JS - в том числе числовые и вызовы 
      функций */}
      <p>{text}</p>
